...
//Si recibio un string del servidor, lo parseo



//Metodo POST pra enviar un nuevo producto a nuestra BD la FakeStoreAPI

fetch('https://fakestoreapi.com/products',{ //endpoint
            method:"POST", //Epecificar el tipo de metodo
            body:JSON.stringify( //instruccion para serializar el cuerpo de mi solicitur (para la interpretacion del servidor)
                {
